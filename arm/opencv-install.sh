...
# Finally, we will be storing the current working directory in cwd variable.
# We are also going to refer to this directory as OpenCV_Home_Dir throughout
# this blog.
...
# Finally, we also need to add a simple statement to make sure that
# VideoCapture(0) works on our Raspberry Pi.
